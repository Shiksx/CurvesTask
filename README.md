# CurvesTask
Тестовое задание на позицию C++.
Библиотека и приложение для работы с кривыми в трехмерном пространстве.
Для сборки и открытия проекта необходимо использовать MSVC 2022.
...
Кривые смоделированы в трехмерном пространстве с помощью параметрических уравнений.
